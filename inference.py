...
labels = ['Mask', 'can', 'cellphone', 'electronics', 'gbottle', 'glove', 'metal', 'net', 'pbag', 'pbottle',
        'plastic', 'rod', 'sunglasses', 'tire']

garbage = []
def detect(image):
    model = YOLO(r"C:\Users\gvign\Downloads\MARINE DEBRIS USING YOLO V8\MARINE DEBRIS USING YOLO V8\models\Underwater_Waste_Detection_YoloV8\60_epochs_denoised.pt")
